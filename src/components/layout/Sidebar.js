...
import logo from "../../assets/images/clickideia.png";
import logoLightPng from "../../assets/images/clickideia.png";
import logoLightSvg from "../../assets/images/clickideia.png";
import logoDark from "../../assets/images/clickideia.png";
          ...
          <div className="navbar-brand-box">
            <Link to="/" className="logo logo-dark">
              ...
              <span className="logo-lg">
                <img src={logoDark} alt="" width="128" height="96" />
              </span>
            </Link>
            ...
            <Link to="/" className="logo logo-light">
              ...
              <span className="logo-lg">
                <img style={{marginTop: 15}} src={logoLightPng} alt="" width="128" height="96" />
              </span>
            </Link>
          </div>
